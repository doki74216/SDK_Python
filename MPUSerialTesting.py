...
def main(arg):
    ...
    #         print m.bucket.name+":"+m.key_name+"\nVersionID: "+m.id 
        ...
        mpu.copy_part_from_key(arg[0],'test1.txt',1,0,5)
        mpu.copy_part_from_key(arg[0],'test1.txt',2)
        mpu.copy_part_from_key(arg[0],'test1.txt',3)
        mpu2.copy_part_from_key(arg[0],'test1.txt',2)
