...
def main(arg):
    try:
        ...
        bucket.add_email_grant('READ', 'w84miracle@gmail.com',True)
        bucket.add_user_grant('FULL_CONTROL', '201721dd4688a6cdebd36b47d96ffe3f2d7d4d1374f36df3e6ada12a139d1c54',True)
        result = repr(bucket.get_acl())
